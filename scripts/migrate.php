...
{
    $required = array('schema_migrations', 'users', 'sessions', 'api_tokens', 'properties', 'property_user_attributes', 'property_tags', 'analyses', 'analysis_jobs', 'cache_entries', 'legacy_data_files');
    $missing = array();
