...
class PropertyPriceAPIProcessor extends cAPI_Processor
{
    ...
    {
        $id=(string)$this->params['property_id']; $listing=(new PropertyRepository($this->pdo))->find($id, $this->user['id']); if(!$listing) throw new APIException(404,'property.not_found','Annonce introuvable.');
