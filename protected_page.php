...
require_once __DIR__ . '/app/Middleware/ApplicationAccessMiddleware.php';
sigma_db(); sigma_require_application_access();
$page = isset($_GET['page']) ? basename((string)$_GET['page']) : '';
$allowed = array('app.html','fiche-bien.html','guide-investissement-locatif.html','guide-mdb-division-parcellaire.html');
